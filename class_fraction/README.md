...
## File: Fraction main (utilisation de la class)
[test_Fraction.py](https://github.com/Durionleponey/DevII/blob/main/class_fraction/main.py)

## Video: Test (utilisation de la class)
